	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<section id="start" class="section-two">
			<div style=" position:absolute;height:100%;width:100%;display:table;text-align:center">
				...
				<a class="page-scroll btn btn-default" href="#information" style="color:white;background-color:#337ab7;"><span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
				</span>
			</div>
		</section>
